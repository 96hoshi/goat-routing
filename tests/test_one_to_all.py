...
from tests.utils.payload_builders import build_one_to_all_payload
...
def test_one_to_all_success_with_builder():
    ...
    expected_motis_payload = build_one_to_all_payload(
...
def test_one_to_all_integration(origin_coord):
    ...
    request_payload = build_one_to_all_payload(
